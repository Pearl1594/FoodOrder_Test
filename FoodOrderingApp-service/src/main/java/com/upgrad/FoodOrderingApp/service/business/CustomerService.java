...
public class CustomerService {
    ...
    public CustomerAuthEntity logout(final String accessToken) throws AuthorizationFailedException {
        ...
        //return loggedOutCustomerAuth.getCustomer();
...
//        }
    ...
    public CustomerEntity updateCustomerPassword(final String oldPassword, final String newPassword, final CustomerEntity customer) throws AuthorizationFailedException, UpdateCustomerException{
        ...
        encryptPassword(customer);
            ...
            System.out.println("Updated password customer == "+ updatedCustomer);
        return updatedCustomer;
    }
    ...
    public CustomerEntity getCustomer(final String accessToken) throws AuthorizationFailedException {
        CustomerAuthEntity customerAuth = customerAuthDao.findByAccessToken(accessToken);
        return customerAuth.getCustomer();
    }

    private void checkCustomer(CustomerAuthEntity customerAuth) throws AuthorizationFailedException {
        final ZonedDateTime now;
    ...
    private boolean fieldsComplete(CustomerEntity customer) {
